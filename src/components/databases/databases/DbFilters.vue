<template>
  <BoxContent title="Databases Filters" border :mbottom="false">
      ...
      <form @submit.prevent="apply">
        ...
        <CustomField label="Version">
          <b-autocomplete
            ...
            :data="filteredData"
            @typing="
              setFilteredAutocomplete($event, 'version', getAllDatabases)
            "
          />
        </CustomField>
        ...
        <CustomField label="Hostname">
          <b-autocomplete
            ...
            :data="filteredData"
            @typing="
              setFilteredAutocomplete($event, 'hostname', getAllDatabases)
            "
          />
        </CustomField>
        ...
        <CustomField label="Charset">
          <b-autocomplete
            ...
            :data="filteredData"
            @typing="
              setFilteredAutocomplete($event, 'charset', getAllDatabases)
            "
          />
        </CustomField>

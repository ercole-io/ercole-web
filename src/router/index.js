...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/licenses/contract/sqlserver',
      ...
      {
        path: '/licenses/contract/postgresql',
      ...
      {
        path: '/licenses/contract/mongodb',
